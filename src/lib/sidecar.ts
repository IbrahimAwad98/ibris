...
export interface SidecarState {
  ...
  /** Edited form fields by name (M4); defaulted to empty on parse. */
  ...
  /** Pending in-place text edits (M6a); defaulted to empty on parse. */
...
export function parseSidecar(
  ...
  return {
    ...
    fieldValues:
      typeof file.fieldValues === "object" && file.fieldValues !== null
        ? file.fieldValues
        : {},
    ...
    redactions:
      typeof file.redactions === "object" && file.redactions !== null
        ...
        : {},
    textEdits:
      typeof file.textEdits === "object" && file.textEdits !== null
        ? file.textEdits
        : {},
